    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-serif font-bold mb-3 dark:text-white tracking-tight">Welcome Back</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Sign in to continue your reading journey.</p>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-black/5 dark:border-white/10 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Don't have an account? <Link href="/register" className="text-[#5A5A40] dark:text-[#c2c2a3] font-bold hover:underline underline-offset-4">Join Free</Link>
          </p>
        </div>
      </motion.div>
    </div>
